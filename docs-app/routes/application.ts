  ...
  async model(): Promise<{ manifest: Manifest }> {
    ...
    const manifest = await setupKolay(this, {
      modules: {
        ...
        "nvp.ui/accordion": () => import("../../src/components/accordion"),
        "nvp.ui/avatar": () => import("../../src/components/avatar"),
        "nvp.ui/breadcrumb": () => import("../../src/components/breadcrumb"),
        "nvp.ui/button": () => import("../../src/components/button"),
        "nvp.ui/dialog": () => import("../../src/components/dialog"),
        "nvp.ui/drawer": () => import("../../src/components/drawer"),
        "nvp.ui/header": () => import("../../src/components/header"),
        "nvp.ui/install-dependency": () => import("../../src/components/install-dependency"),
        "nvp.ui/menu": () => import("../../src/components/menu"),
        "nvp.ui/tabbed-shell-script": () => import("../../src/components/tabbed-shell-script"),
